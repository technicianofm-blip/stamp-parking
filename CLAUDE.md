...
| `test-duplicate.js` | Test feature ตรวจเลขบัตรซ้ำวันเดียวกัน — unit `bkkDay` + E2E mock (รัน: `node test-duplicate.js` ควรได้ 4/4 + 13/13) |
...
# 🔁 ทดสอบ feature ตรวจเลขบัตรซ้ำวันเดียวกัน (unit bkkDay + E2E mock) — ควรได้ 4/4 + 13/13
